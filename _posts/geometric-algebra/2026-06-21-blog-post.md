...
Let \\(\boldsymbol{v} = \boldsymbol{v}\_{\perp} + \sum\_{i=1}^{r} v\_{i} \boldsymbol{e}\_{i}\\), where \\(\boldsymbol{v}\_{\perp} \perp V\\). Let the \\(r\\)-blade be \\(A\_{r} := \boldsymbol{e}\_{1} \wedge \cdots \wedge \boldsymbol{e}\_{r} = \boldsymbol{e}\_{1} \cdots \boldsymbol{e}\_{r}\\). Then,
<p>
